create_analysis_mode -name CONSTRAINTS -constraint_file ../FromSYN/mac8_dualmode.sdc
create_lib_set -name TTlib -timing_lib { \
  ../../../Common/ics55_LLSC_H9CR_0917/liberty/lib/ics55_LLSC_H9CR_typ_tt_1p2_25_nldm.lib \
}
create_lib_set -name FFlib -timing_lib { \
  ../../../Common/ics55_LLSC_H9CR_0917/liberty/lib/ics55_LLSC_H9CR_ff_rcbest_1p32_m40_nldm.lib \
}
create_lib_set -name SSlib -timing_lib { \
  ../../../Common/ics55_LLSC_H9CR_0917/liberty/lib/ics55_LLSC_H9CR_ss_cworst_1p08_m40_nldm.lib \
}
create_rc_corner -name tt_1p2_25c -rc_tech ../../../Common/ics55_LLSC_H9CR_0917/rc_tech/N55_typ.rc_tech
create_rc_corner -name rcbest_1p32_m40c -rc_tech ../../../Common/ics55_LLSC_H9CR_0917/rc_tech/N55_RCbest.rc_tech
create_rc_corner -name cworst_1p08_m40c -rc_tech ../../../Common/ics55_LLSC_H9CR_0917/rc_tech/N55_Cworst.rc_tech
